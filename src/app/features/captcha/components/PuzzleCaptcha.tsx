...
type PuzzleCaptchaProp = {
  onRef?: RefObject<PuzzleCaptchaRef | null>;
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden" style={{ borderRadius: radius }}>
        ...
        <canvas ref={puzzleRef} width={width} height={height} className="absolute top-0" />
        <div
          className="absolute bottom-0 left-0 w-full text-center leading-6 text-white text-xs"
          style={{
            opacity: showTip ? 1 : 0,
        ...
        >
          {isPassing ? successText : failText}
        </div>
      ...
      >
        <div
          className="absolute top-0 left-0 bg-[#d1e9fe]"
          style={{
            width: `${sliderLeft}px`,
            height: slideHeight,
          }}
        >
          <div
            className="absolute top-0 flex justify-center items-center bg-white cursor-grab z-50 border box-border"
            style={{
              width: slideHeight,
              height: slideHeight,
              left: `${sliderLeft}px`,
